/*
    ...
    [position player] execVM "USER\functions\fn_scanFX.sqf";
*/

params ["_unit"];

private _centerPos = _unit getPos [5, getDir _unit];
_centerPos set [2, 2];
...
for "_i" from 1 to 360 do {
    ...
    */
    _source01 setDropInterval 4;

    [{ params ["_source"]; deleteVehicle _source; }, [_source01], 1] call CBA_fnc_waitAndExecute;
};
